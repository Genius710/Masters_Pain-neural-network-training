...
epoch_no = 50
size = 256;
# model = tf.keras.models.load_model('RawSignalMean1Features_MLP_v1_recog/1')

# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])

# for iii in range(1,eep):
#     history = model.fit(InputMean1 ,LabelMean1C ,epochs = epoch_no,batch_size =size,validation_data =(InputMeanV1 ,LabelMeanV1C ))
#     model.save(pjoin('RawSignalMean1Features_MLP_v1_recog/',str(iii*50+0)))
#     plt.plot(history.history['val_categorical_accuracy'])
#     plt.plot(history.history['categorical_accuracy'])
   
    
# model = tf.keras.models.load_model('RawSignalMean1Features_LSTM_v1_recog/1')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])

# for iii in range(1,eep):
#     history = model.fit(InputMean1LSTM,LabelMean1CLSTM,epochs = epoch_no,batch_size =size,validation_data =(InputMeanV1LSTM,LabelMeanV1CLSTM))
#     model.save(pjoin('RawSignalMean1Features_LSTM_v1_recog/',str(iii*50+0)))
#     plt.plot(history.history['val_categorical_accuracy'])
#     plt.plot(history.history['categorical_accuracy'])    
    

# model = tf.keras.models.load_model('RawSignalMean1Features_CNN_v1_recog/1')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])

# for iii in range(1,eep):
#     history = model.fit(InputMean1CNN,LabelMean1CCNN,epochs = epoch_no,batch_size =size,validation_data =(InputMeanV1CNN,LabelMeanV1CCNN))
#     model.save(pjoin('RawSignalMean1Features_CNN_v1_recog/',str(iii*50+0)))
#     plt.plot(history.history['val_categorical_accuracy'])
#     plt.plot(history.history['categorical_accuracy'])
...
# model = tf.keras.models.load_model('RawSignalMean5Features_MLP_v1_recog/150')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])

# for iii in range(4,eep):
#     history = model.fit(InputMean5 ,LabelMean5C ,epochs = epoch_no,batch_size =size,validation_data =(InputMeanV5 ,LabelMeanV5C ))
#     model.save(pjoin('RawSignalMean5Features_MLP_v1_recog/',str(iii*50+0)))
#     plt.plot(history.history['val_categorical_accuracy'])
#     plt.plot(history.history['categorical_accuracy'])


model = tf.keras.models.load_model('RawSignalMean5Features_CNN_v1_recog/1')
...
for iii in range(1,eep):
    ...
    model.save(pjoin('RawSignalMean5Features_CNN_v1_recog/',str(iii*50+000)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])

model = tf.keras.models.load_model('RawSignalMean5Features_LSTM_v1_recog/1')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
for iii in range(1,eep):
    ...
    model.save(pjoin('RawSignalMean5Features_LSTM_v1_recog/',str(iii*50+0)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
...
model = tf.keras.models.load_model('RawSignalMean12Features_CNN_v1_recog/1')
...
for iii in range(1,eep):
    ...
    model.save(pjoin('RawSignalMean12Features_CNN_v1_recog/',str(iii*50+0)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
    

model = tf.keras.models.load_model('RawSignalMean12Features_MLP_v1_recog/1')
...
for iii in range(1,eep):
    ...
    model.save(pjoin('RawSignalMean12Features_MLP_v1_recog/',str(iii*50+0)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])

model = tf.keras.models.load_model('RawSignalMean12Features_LSTM_v1_recog/1')
...
for iii in range(1,eep):
    ...
    model.save(pjoin('RawSignalMean12Features_LSTM_v1_recog/',str(iii*50+0)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
