...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixLongV1_triclass.mat')
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixLongV5_triclass.mat')
mat_contents = sio.loadmat(mat_fname)
DataMatrix = np.array(mat_contents['DataMatrixLongV'])
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixLongV12_triclass.mat')
mat_contents = sio.loadmat(mat_fname)
DataMatrix = np.array(mat_contents['DataMatrixLongV'])
...
np.savetxt(pjoin(path,'MLP_Long1_results.txt'),model.predict(InputLongTriclassV1))

path = 'Trained/RawSignalLong1_CNN_v1_triclass/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'CNN_Long1_results.txt'),model.predict(InputLongTriclassV1CNN))

path = 'Trained/RawSignalLong1_LSTM_v1_triclass/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'LSTM_Long1_results.txt'),model.predict(InputLongTriclassV1LSTM))    


path = 'Trained/RawSignalLong5_MLP_v1_triclass/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'MLP_Long5_results.txt'),model.predict(InputLongTriclassV5))

path = 'Trained/RawSignalLong5_CNN_v1_triclass/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'CNN_Long5_results.txt'),model.predict(InputLongTriclassV5CNN))

path = 'Trained/RawSignalLong5_LSTM_v1_triclass/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'LSTM_Long5_results.txt'),model.predict(InputLongTriclassV5LSTM))    
...
# model = tf.keras.models.load_model(pjoin(path,'500')) 
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])  
# np.savetxt(pjoin(path,'CNN_Long12_results.txt'),model.predict(InputLongTriclassV12CNN))
...
# np.savetxt(pjoin(path,'MLP_Long12_results.txt'),model.predict(InputLongTriclassV12))
...
# model.compile('adamax', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
# np.savetxt(pjoin(path,'LSTM_Long12_results.txt'),model.predict(InputLongTriclassV12LSTM))
...
# model = tf.keras.models.load_model(pjoin(path,'500')) 
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
# np.savetxt(pjoin(path,'MLP_Long1_results.txt'),model.predict(InputLongRecogV1))

# path = 'Trained/RawSignalLong1_CNN_v1_recog/'
# model = tf.keras.models.load_model(pjoin(path,'500')) 
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
# np.savetxt(pjoin(path,'CNN_Long1_results.txt'),model.predict(InputLongRecogV1CNN))

# path = 'Trained/RawSignalLong1_LSTM_v1_recog/'
# model = tf.keras.models.load_model(pjoin(path,'500')) 
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
# np.savetxt(pjoin(path,'LSTM_Long1_results.txt'),model.predict(InputLongRecogV1LSTM))   
...
# model = tf.keras.models.load_model(pjoin(path,'500')) 
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
# np.savetxt(pjoin(path,'MLP_Long5_results.txt'),model.predict(InputLongRecogV5))

# path = 'Trained/RawSignalLong5_CNN_v1_recog/'
# model = tf.keras.models.load_model(pjoin(path,'500')) 
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
# np.savetxt(pjoin(path,'CNN_Long5_results.txt'),model.predict(InputLongRecogV5CNN))

# path = 'Trained/RawSignalLong5_LSTM_v1_recog/'
# model = tf.keras.models.load_model(pjoin(path,'300')) 
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
# np.savetxt(pjoin(path,'LSTM_Long5_results.txt'),model.predict(InputLongRecogV5LSTM))    
...
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])  
# np.savetxt(pjoin(path,'CNN_Long12_results.txt'),model.predict(InputLongRecogV12CNN))

# path = 'Trained/RawSignalLong12_MLP_v1_recog/'
# model = tf.keras.models.load_model(pjoin(path,'500')) 
# model.compile('adamax', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
# np.savetxt(pjoin(path,'MLP_Long12_results.txt'),model.predict(InputLongRecogV12))

# path = 'Trained/RawSignalLong12_LSTM_v1_recog/'
# model = tf.keras.models.load_model(pjoin(path,'500')) 
# model.compile('adamax', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
# np.savetxt(pjoin(path,'LSTM_Long12_results.txt'),model.predict(InputLongRecogV12LSTM))
