...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixFeatures1.mat')
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixFeaturesV1.mat')
...
# model = tf.keras.models.load_model('Feature_model_68_MLP_multi_1_v1/900')
# model = tf.keras.models.load_model('Feature_model_68_LSTM_multi_1_v1/600')
model = tf.keras.models.load_model('Feature_model_68_CNN_multi_1_v1/900')
...
np.savetxt('Feature_model_68_CNN_multi_1_v1_results.txt',np.argmax(model.predict(InputV),1))
# np.savetxt('Feature_model_68_MLP_multi_1_v1_results.txt',np.argmax(model.predict(InputV),1))
# np.savetxt('Feature_model_68_LSTM_multi_1_v1_results.txt',np.argmax(model.predict(InputV),1))
