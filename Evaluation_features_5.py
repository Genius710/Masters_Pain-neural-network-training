...
model = tf.keras.models.load_model('Feature_model_68_MLP_multi_5_v1/900')
# model = tf.keras.models.load_model('Feature_model_68_LSTM_multi_5_v1/600')
# model = tf.keras.models.load_model('Feature_model_68_CNN_multi_5_v1/900')
...
# np.savetxt('Feature_model_68_CNN_multi_5_v1_results.txt',np.argmax(model.predict(InputV),1))
np.savetxt('Feature_model_68_MLP_multi_5_v1_results.txt',np.argmax(model.predict(InputV),1))
# np.savetxt('Feature_model_68_LSTM_multi_5_v1_results.txt',np.argmax(model.predict(InputV),1))
