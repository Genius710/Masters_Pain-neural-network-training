...
model = tf.keras.models.load_model('Trained/RawSignalMean5_MLP_v1_triclass/500')
...
model = tf.keras.models.load_model('Trained/RawSignalMean5_CNN_v1_triclass/500')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
model = tf.keras.models.load_model('Trained/RawSignalMean5_LSTM_v1_triclass/500')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
model = tf.keras.models.load_model('Trained/RawSignalMean12_CNN_v1_triclass/500')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
model = tf.keras.models.load_model('Trained/RawSignalMean12_MLP_v1_triclass/500')
...
model = tf.keras.models.load_model('Trained/RawSignalMean12_LSTM_v1_triclass/500')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
