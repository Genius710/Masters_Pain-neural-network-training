...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixLong5Features_triclass.mat')
mat_contents = sio.loadmat(mat_fname)
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixLongV5Features_triclass.mat')
mat_contents = sio.loadmat(mat_fname)
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixLong12Features_triclass.mat')
mat_contents = sio.loadmat(mat_fname)
DataMatrix = np.array(mat_contents['EqualisedDataMatrixLong'])
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixLongV12Features_triclass.mat')
mat_contents = sio.loadmat(mat_fname)
DataMatrix = np.array(mat_contents['EqualisedDataMatrixLongV'])
...
model = tf.keras.models.load_model('Trained/RawSignalLong1Features_MLP_v1_triclass/450')
...
model = tf.keras.models.load_model('Trained/RawSignalLong1Features_LSTM_v1_triclass/450')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
model = tf.keras.models.load_model('Trained/RawSignalLong1Features_CNN_v1_triclass/450')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
model = tf.keras.models.load_model('Trained/RawSignalLong5Features_MLP_v1_triclass/450')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
history = model.fit(InputLong5 ,LabelLong5C ,epochs = epoch_no,batch_size =128,validation_data =(InputLongV5 ,LabelLongV5C ))


model = tf.keras.models.load_model('Trained/RawSignalLong5Features_CNN_v1_triclass/450')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
model = tf.keras.models.load_model('Trained/RawSignalLong5Features_LSTM_v1_triclass/450')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
model = tf.keras.models.load_model('Trained/RawSignalLong12Features_CNN_v1_triclass/450')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
model = tf.keras.models.load_model('Trained/RawSignalLong12Features_MLP_v1_triclass/450')
...
model = tf.keras.models.load_model('Trained/RawSignalLong12Features_LSTM_v1_triclass/450')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
