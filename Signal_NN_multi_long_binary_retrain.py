...
eep = 11
epoch_no = 50
# model = tf.keras.models.load_model('RawSignalLong1_MLP_v1_recog/1')
...
# model = tf.keras.models.load_model('RawSignalLong1_LSTM_v1_recog/1')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
# model = tf.keras.models.load_model('RawSignalLong1_CNN_v1_recog/1')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
# model = tf.keras.models.load_model('RawSignalLong5_MLP_v1_recog/1')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
# model = tf.keras.models.load_model('RawSignalLong5_CNN_v1_recog/100')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
# model = tf.keras.models.load_model('RawSignalLong12_CNN_v1_recog/1')
...
model = tf.keras.models.load_model('Trained/RawSignalLong12_MLP_v1_recog/1')
...
for iii in range(5,eep):
    ...
    # model.save(pjoin('RawSignalLong12_MLP_v1_recog/',str(iii*50+0)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
# multi =12
...
# model = tf.keras.models.load_model('RawSignalLong5_LSTM_v1_recog/100')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])

# for iii in range(3,eep):
#     history = model.fit(InputLong5LSTM,LabelLong5CLSTM,epochs = epoch_no,batch_size =64,validation_data =(InputLongV5LSTM,LabelLongV5CLSTM))
