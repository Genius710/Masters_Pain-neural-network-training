...
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMean01_recog.mat')
# mat_contents = h5py.File(mat_fname,'r')
# DataMatrix0 = np.swapaxes(np.array(mat_contents['EqualisedDataMatrixMean0']),0,1)
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMean11_recog.mat')
# mat_contents = h5py.File(mat_fname,'r')
...
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMeanV01_recog.mat')
# mat_contents = h5py.File(mat_fname,'r')
# DataMatrix0 = np.swapaxes(np.array(mat_contents['EqualisedDataMatrixMeanV0']),0,1)
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMeanV11_recog.mat')
# mat_contents = h5py.File(mat_fname,'r')
...
InputMeanV5 = DataMatrix[:,2:2+multi*VECL]
...
InputMeanV12 = DataMatrix[:,2:2+multi*VECL]
...
#     history = model.fit(InputMean1 ,LabelMean1C ,epochs = 1,batch_size =32,validation_data =(InputMeanV1 ,LabelMeanV1C ))
#     model.save(pjoin('RawSignalMean1_MLP_v1_recog/',str(iii*1+0)))
...
# for iii in range(1,2):
#     history = model.fit(InputMean1LSTM,LabelMean1CLSTM,epochs = 1,batch_size =32,validation_data =(InputMeanV1LSTM,LabelMeanV1CLSTM))
#     model.save(pjoin('RawSignalMean1_LSTM_v1_recog/',str(iii*1+0)))
#     plt.plot(history.history['val_categorical_accuracy'])
#     plt.plot(history.history['categorical_accuracy'])    
...
# for iii in range(1,2):
#     history = model.fit(InputMean1CNN,LabelMean1CCNN,epochs = 1,batch_size =32,validation_data =(InputMeanV1CNN,LabelMeanV1CCNN))
#     model.save(pjoin('RawSignalMean1_CNN_v1_recog/',str(iii*1+0)))
#     plt.plot(history.history['val_categorical_accuracy'])
#     plt.plot(history.history['categorical_accuracy'])
...
for iii in range(1,2):
    history = model.fit(InputMean5 ,LabelMean5C ,epochs = 1,batch_size =32,validation_data =(InputMeanV5 ,LabelMeanV5C ))
    model.save(pjoin('RawSignalMean5_MLP_v1_recog/',str(iii*1+0)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
...
for iii in range(1,2):
    history = model.fit(InputMean5CNN,LabelMean5CCNN,epochs = 1,batch_size =32,validation_data =(InputMeanV5CNN,LabelMeanV5CCNN))
    model.save(pjoin('RawSignalMean5_CNN_v1_recog/',str(iii*1+0)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
...
for iii in range(1,2):
    history = model.fit(InputMean5LSTM,LabelMean5CLSTM,epochs = 1,batch_size =32,validation_data =(InputMeanV5LSTM,LabelMeanV5CLSTM))
    model.save(pjoin('RawSignalMean5_LSTM_v1_recog/',str(iii*1+0)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
...
for iii in range(1,2):
    history = model.fit(InputMean12CNN,LabelMean12CCNN,epochs = 1,batch_size =32,validation_data =(InputMeanV12CNN,LabelMeanV12CCNN))
    model.save(pjoin('RawSignalMean12_CNN_v1_recog/',str(iii*1+0)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
...
for iii in range(1,2):
    history = model.fit(InputMean12 ,LabelMean12C ,epochs = 1,batch_size =32,validation_data =(InputMeanV12 ,LabelMeanV12C ))
    model.save(pjoin('RawSignalMean12_MLP_v1_recog/',str(iii*1+0)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
...
for iii in range(1,2):
    history = model.fit(InputMean12LSTM,LabelMean12CLSTM,epochs = 1,batch_size =32,validation_data =(InputMeanV12LSTM,LabelMeanV12CLSTM))
    model.save(pjoin('RawSignalMean12_LSTM_v1_recog/',str(iii*1+0)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
