...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixLong01Features_triclass.mat')
mat_contents = h5py.File(mat_fname,'r')
DataMatrix0 = np.swapaxes(np.array(mat_contents['EqualisedDataMatrixLong0']),0,1)
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixLong11Features_triclass.mat')
mat_contents = h5py.File(mat_fname,'r')
DataMatrix1 = np.swapaxes(np.array(mat_contents['EqualisedDataMatrixLong1']),0,1)

InputLongFeaturesTriclassV1 = np.vstack(( DataMatrix0[:,2:2+multi*VECL],DataMatrix1[:,2:2+multi*VECL]))
LabelLongFeaturesTriclassV1 = np.hstack(( DataMatrix0[:,0],DataMatrix1[:,0]))
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixLong05Features_triclass.mat')
mat_contents = h5py.File(mat_fname,'r')
DataMatrix0 = np.swapaxes(np.array(mat_contents['EqualisedDataMatrixLong0']),0,1)
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixLong15Features_triclass.mat')
mat_contents = h5py.File(mat_fname,'r')
DataMatrix1 = np.swapaxes(np.array(mat_contents['EqualisedDataMatrixLong1']),0,1)

InputLongFeaturesTriclassV5  = np.vstack(( DataMatrix0[:,2:2+multi*VECL],DataMatrix1[:,2:2+multi*VECL]))
LabelLongFeaturesTriclassV5 = np.hstack(( DataMatrix0[:,0],DataMatrix1[:,0]))
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixLong012Features_triclass.mat')
mat_contents = h5py.File(mat_fname,'r')
DataMatrix0 = np.swapaxes(np.array(mat_contents['EqualisedDataMatrixLong0']),0,1)
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixLong112Features_triclass.mat')
mat_contents = h5py.File(mat_fname,'r')
DataMatrix1 = np.swapaxes(np.array(mat_contents['EqualisedDataMatrixLong1']),0,1)

InputLongFeaturesTriclassV12 = np.vstack(( DataMatrix0[:,2:2+multi*VECL],DataMatrix1[:,2:2+multi*VECL]))
LabelLongFeaturesTriclassV12 = np.hstack(( DataMatrix0[:,0],DataMatrix1[:,0]))
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixLong1Features_recog.mat')
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixLong5Features_recog.mat')
mat_contents = sio.loadmat(mat_fname)
DataMatrix = np.array(mat_contents['DataMatrixLong'])
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixLong12Features_recog.mat')
mat_contents = sio.loadmat(mat_fname)
DataMatrix = np.array(mat_contents['DataMatrixLong'])
...
np.savetxt(pjoin(path,'MLP_Long1_train_train_results.txt'),model.predict(InputLongFeaturesTriclassV1))

path = 'Trained/RawSignalLong1Features_CNN_v1_triclass/'
model = tf.keras.models.load_model(pjoin(path,'450')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'CNN_Long1_train_train_results.txt'),model.predict(InputLongFeaturesTriclassV1CNN))

path = 'Trained/RawSignalLong1Features_LSTM_v1_triclass/'
model = tf.keras.models.load_model(pjoin(path,'450')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'LSTM_Long1_train_train_results.txt'),model.predict(InputLongFeaturesTriclassV1LSTM))    


path = 'Trained/RawSignalLong5Features_MLP_v1_triclass/'
model = tf.keras.models.load_model(pjoin(path,'450')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'MLP_Long5_train_train_results.txt'),model.predict(InputLongFeaturesTriclassV5))

path = 'Trained/RawSignalLong5Features_CNN_v1_triclass/'
model = tf.keras.models.load_model(pjoin(path,'450')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'CNN_Long5_train_train_results.txt'),model.predict(InputLongFeaturesTriclassV5CNN))

path = 'Trained/RawSignalLong5Features_LSTM_v1_triclass/'
model = tf.keras.models.load_model(pjoin(path,'450')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'LSTM_Long5_train_train_results.txt'),model.predict(InputLongFeaturesTriclassV5LSTM))    
...
model = tf.keras.models.load_model(pjoin(path,'450')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])  
np.savetxt(pjoin(path,'CNN_Long12_train_train_results.txt'),model.predict(InputLongFeaturesTriclassV12CNN))
...
np.savetxt(pjoin(path,'MLP_Long12_train_train_results.txt'),model.predict(InputLongFeaturesTriclassV12))

path = 'Trained/RawSignalLong12Features_LSTM_v1_triclass/'
model = tf.keras.models.load_model(pjoin(path,'450')) 
model.compile('adamax', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'LSTM_Long12_train_train_results.txt'),model.predict(InputLongFeaturesTriclassV12LSTM))
...
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'MLP_Long1_train_train_results.txt'),model.predict(InputLongFeaturesRecogV1))

path = 'Trained/RawSignalLong1Features_CNN_v1_recog/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'CNN_Long1_train_train_results.txt'),model.predict(InputLongFeaturesRecogV1CNN))

path = 'Trained/RawSignalLong1Features_LSTM_v1_recog/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'LSTM_Long1_train_train_results.txt'),model.predict(InputLongFeaturesRecogV1LSTM))   
...
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'MLP_Long5_train_train_results.txt'),model.predict(InputLongFeaturesRecogV5))

path = 'Trained/RawSignalLong5Features_CNN_v1_recog/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'CNN_Long5_train_train_results.txt'),model.predict(InputLongFeaturesRecogV5CNN))

path = 'Trained/RawSignalLong5Features_LSTM_v1_recog/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'LSTM_Long5_train_train_results.txt'),model.predict(InputLongFeaturesRecogV5LSTM))    
...
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])  
np.savetxt(pjoin(path,'CNN_Long12_train_train_results.txt'),model.predict(InputLongFeaturesRecogV12CNN))

path = 'Trained/RawSignalLong12Features_MLP_v1_recog/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adamax', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'MLP_Long12_train_train_results.txt'),model.predict(InputLongFeaturesRecogV12))

path = 'Trained/RawSignalLong12Features_LSTM_v1_recog/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adamax', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'LSTM_Long12_train_train_results.txt'),model.predict(InputLongFeaturesRecogV12LSTM))
