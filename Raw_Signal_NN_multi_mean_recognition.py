...
DataMatrix = mat_contents['EqualisedDataMatrixMean']
Input = DataMatrix[:,2:2+multi*VECL]
Label = DataMatrix[:,0]
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\LOO1_EqualisedDataMatrixMean12.mat')
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\DataMatrixEqualized_53_multi_12_averaged_v2.mat')
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMean012.mat')
...
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMean112.mat')
# # mat_contents = h5py.File(mat_fname,'r')
# mat_contents = sio.loadmat(mat_fname)
# DataMatrix1 = np.swapaxes(np.array(mat_contents['EqualisedDataMatrixMean1']),0,1)
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMean212.mat')
# # mat_contents = h5py.File(mat_fname,'r')
# mat_contents = sio.loadmat(mat_fname)
# DataMatrix2 = np.swapaxes(np.array(mat_contents['EqualisedDataMatrixMean2']),0,1)
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMean312.mat')
# # mat_contents = h5py.File(mat_fname,'r')
# mat_contents = sio.loadmat(mat_fname)
# DataMatrix3 = np.swapaxes(np.array(mat_contents['EqualisedDataMatrixMean3']),0,1)
...
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\LOO1_EqualisedDataMatrixMeanV12.mat')
# mat_contents = sio.loadmat(mat_fname)
# DataMatrix = np.array(mat_contents['EqualisedDataMatrixMeanV'])

# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMeanV012.mat')
# mat_contents = sio.loadmat(mat_fname)
# DataMatrix0 = np.array(mat_contents['EqualisedDataMatrixMeanV0'])
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMeanV112.mat')
# mat_contents = sio.loadmat(mat_fname)
# DataMatrix1 = np.array(mat_contents['EqualisedDataMatrixMeanV1'])
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMeanV212.mat')
# mat_contents = sio.loadmat(mat_fname)
# DataMatrix2 = np.array(mat_contents['EqualisedDataMatrixMeanV2'])
# mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMeanV312.mat')
# mat_contents = sio.loadmat(mat_fname)
# DataMatrix3 = np.array(mat_contents['EqualisedDataMatrixMeanV3'])
...
mat_contents = sio.loadmat(mat_fname)
DataMatrix = mat_contents['EqualisedDataMatrixMeanV']
...
# [x] = Label_IR.shape
# LabelC_IR = np.empty([x,2], dtype=int)
...
# Input = Input.reshape(-1,1,VECL)
# LabelC = LabelC.reshape(-1,2,1)


# InputV = InputV.reshape(-1,1,VECL)
# LabelVC = LabelVC.reshape(-1,2,1)
...
for iii in range(1,101):
    history = model.fit(Input,LabelC,epochs = 10,batch_size =256,validation_data =(InputV,LabelVC))
    model.save(pjoin('RawSignalMean5_MLP_recognition_v1/',str(iii*10)))
