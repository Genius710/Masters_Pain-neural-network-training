...
model = tf.keras.models.load_model('RawSignalMean12Features_MLP_v1_triclass/1')
...
for iii in range(1,10):
    ...
    model.save(pjoin('RawSignalMean12Features_MLP_v1_triclass/',str(iii*50+1)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
    
model = tf.keras.models.load_model('RawSignalMean5Features_MLP_v1_triclass/1')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])

for iii in range(1,10):
    history = model.fit(InputMean5 ,LabelMean5C ,epochs = 50,batch_size =32,validation_data =(InputMean5V ,LabelMean5VC ))
    model.save(pjoin('RawSignalMean5Features_MLP_v1_triclass/',str(iii*50+1)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])


    
model = tf.keras.models.load_model('RawSignalMean12Features_LSTM_v1_triclass/1')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
for iii in range(1,10):
    ...
    model.save(pjoin('RawSignalMean12Features_LSTM_v1_triclass/',str(iii*50+1)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
    
model = tf.keras.models.load_model('RawSignalMean5Features_LSTM_v1_triclass/1')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
for iii in range(1,10):
    ...
    model.save(pjoin('RawSignalMean5Features_LSTM_v1_triclass/',str(iii*50+1)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])


    
model = tf.keras.models.load_model('RawSignalMean12Features_CNN_v1_triclass/1')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
for iii in range(1,10):
    ...
    model.save(pjoin('RawSignalMean12Features_CNN_v1_triclass/',str(iii*50+1)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
    
model = tf.keras.models.load_model('RawSignalMean5Features_CNN_v1_triclass/1')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])

for iii in range(1,10):
    history = model.fit(InputMean5CNN,LabelMean5CCNN,epochs = 50,batch_size =32,validation_data =(InputMean5VCNN,LabelMean5VCCNN))
    model.save(pjoin('RawSignalMean5Features_CNN_v1_triclass/',str(iii*50+1)))
    plt.plot(history.history['val_categorical_accuracy'])
    plt.plot(history.history['categorical_accuracy'])
