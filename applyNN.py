...
import keras
model = tf.keras.models.load_model('model_whitelisted')
...
# x_train,  y_train,x_test, y_test = train_test_split(InputN, NPRSNF, test_size=0.2)
...
# model.fit(x_train,x_test,epochs = 200,validation_data =(y_train,y_test))
