...
#     history = model.fit(InputLong1 ,LabelLong1C ,epochs = 1,batch_size =32,validation_data =(InputLongV1 ,LabelLongV1C ))
#     model.save(pjoin('RawSignalLong1_MLP_v1_recog/',str(iii*1+0)))
...
# for iii in range(1,2):
#     history = model.fit(InputLong1LSTM,LabelLong1CLSTM,epochs = 1,batch_size =32,validation_data =(InputLongV1LSTM,LabelLongV1CLSTM))
#     model.save(pjoin('RawSignalLong1_LSTM_v1_recog/',str(iii*1+0)))
#     plt.plot(history.history['val_categorical_accuracy'])
#     plt.plot(history.history['categorical_accuracy'])    
...
# for iii in range(1,2):
#     history = model.fit(InputLong1CNN,LabelLong1CCNN,epochs = 1,batch_size =32,validation_data =(InputLongV1CNN,LabelLongV1CCNN))
#     model.save(pjoin('RawSignalLong1_CNN_v1_recog/',str(iii*1+0)))
#     plt.plot(history.history['val_categorical_accuracy'])
#     plt.plot(history.history['categorical_accuracy'])
...
# for iii in range(1,2):
#     history = model.fit(InputLong5 ,LabelLong5C ,epochs = 1,batch_size =32,validation_data =(InputLongV5 ,LabelLongV5C ))
#     model.save(pjoin('RawSignalLong5_MLP_v1_recog/',str(iii*1+0)))
#     plt.plot(history.history['val_categorical_accuracy'])
#     plt.plot(history.history['categorical_accuracy'])
...
# for iii in range(1,2):
#     history = model.fit(InputLong5CNN,LabelLong5CCNN,epochs = 1,batch_size =32,validation_data =(InputLongV5CNN,LabelLongV5CCNN))
#     model.save(pjoin('RawSignalLong5_CNN_v1_recog/',str(iii*1+0)))
#     plt.plot(history.history['val_categorical_accuracy'])
#     plt.plot(history.history['categorical_accuracy'])
...
# for iii in range(1,2):
#     history = model.fit(InputLong5LSTM,LabelLong5CLSTM,epochs = 1,batch_size =32,validation_data =(InputLongV5LSTM,LabelLongV5CLSTM))
#     model.save(pjoin('RawSignalLong5_LSTM_v1_recog/',str(iii*1+0)))
#     plt.plot(history.history['val_categorical_accuracy'])
#     plt.plot(history.history['categorical_accuracy'])
...
# for iii in range(1,2):
#     history = model.fit(InputLong12CNN,LabelLong12CCNN,epochs = 1,batch_size =32,validation_data =(InputLongV12CNN,LabelLongV12CCNN))
...
# for iii in range(1,2):
#     history = model.fit(InputLong12 ,LabelLong12C ,epochs = 1,batch_size =32,validation_data =(InputLongV12 ,LabelLongV12C ))
#     model.save(pjoin('RawSignalLong12_MLP_v1_recog/',str(iii*1+0)))
#     plt.plot(history.history['val_categorical_accuracy'])
#     plt.plot(history.history['categorical_accuracy'])
# multi =12
...
# for iii in range(1,2):
#     history = model.fit(InputLong12LSTM,LabelLong12CLSTM,epochs = 1,batch_size =16,validation_data =(InputLongV12LSTM,LabelLongV12CLSTM))
