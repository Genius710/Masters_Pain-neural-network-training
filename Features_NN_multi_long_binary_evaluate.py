...
path = 'RawSignalLong1Features_MLP_v1_recog/'
...
path = 'RawSignalLong1Features_LSTM_v1_recog/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
np.savetxt(pjoin(path,'LSTM_Long1_results.txt'),model.predict(InputLongV1LSTM))   
 
path = 'RawSignalLong1Features_CNN_v1_recog/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
path = 'RawSignalLong12Features_CNN_v1_recog/'
...
path = 'RawSignalLong12Features_MLP_v1_recog/'
model = tf.keras.models.load_model(pjoin(path,'500')) 
...
path = 'RawSignalLong12Features_LSTM_v1_recog/'
model = tf.keras.models.load_model(pjoin(path,'')) 
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
