...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMean5Features_recog.mat')
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\\EqualisedDataMatrixMeanV5Features_recog.mat')
mat_contents = sio.loadmat(mat_fname)
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\EqualisedDataMatrixMean12Features_recog.mat')
mat_contents = sio.loadmat(mat_fname)
DataMatrix = np.array(mat_contents['EqualisedDataMatrixMean'])
...
mat_fname = pjoin('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\\EqualisedDataMatrixMeanV12Features_recog.mat')
mat_contents = sio.loadmat(mat_fname)
DataMatrix = np.array(mat_contents['EqualisedDataMatrixMeanV'])
...
model = tf.keras.models.load_model('Trained/RawSignalMean12Features_MLP_v1_recog/500')
...
model = tf.keras.models.load_model('Trained/RawSignalMean5Features_MLP_v1_recog/500')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
history = model.fit(InputMean5 ,LabelMean5C ,epochs = 1,batch_size =32,validation_data =(InputMean5V ,LabelMean5VC ))

model = tf.keras.models.load_model('Trained/RawSignalMean12Features_LSTM_v1_recog/500')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
model = tf.keras.models.load_model('Trained/RawSignalMean5Features_LSTM_v1_recog/500')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
history = model.fit(InputMean5LSTM,LabelMean5CLSTM,epochs = 1,batch_size =32,validation_data =(InputMean5VLSTM,LabelMean5VCLSTM))


    
model = tf.keras.models.load_model('Trained/RawSignalMean12Features_CNN_v1_recog/500')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
history = model.fit(InputMean12CNN,LabelMean12CCNN,epochs = 1,batch_size =32,validation_data =(InputMean12VCNN,LabelMean12VCCNN))

    
model = tf.keras.models.load_model('Trained/RawSignalMean5Features_CNN_v1_recog/500')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
