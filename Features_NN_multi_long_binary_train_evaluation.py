...
model = tf.keras.models.load_model('Trained/RawSignalLong1Features_MLP_v1_recog/500')
...
# model = tf.keras.models.load_model('Trained/RawSignalLong1Features_LSTM_v1_recog/500')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
# model = tf.keras.models.load_model('Trained/RawSignalLong1Features_CNN_v1_recog/500')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
# model = tf.keras.models.load_model('Trained/RawSignalLong5Features_MLP_v1_recog/500')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
# history = model.fit(InputLong5 ,LabelLong5C ,epochs = epoch_no,batch_size =128,validation_data =(InputLongV5 ,LabelLongV5C ))


# model = tf.keras.models.load_model('Trained/RawSignalLong5Features_CNN_v1_recog/500')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
# model = tf.keras.models.load_model('Trained/RawSignalLong5Features_LSTM_v1_recog/500')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
# model = tf.keras.models.load_model('Trained/RawSignalLong12Features_CNN_v1_recog/210')
# model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
...
# model = tf.keras.models.load_model('Trained/RawSignalLong12Features_MLP_v1_recog/500')
...
model = tf.keras.models.load_model('Trained/RawSignalLong12Features_LSTM_v1_recog/500')
model.compile('adam', loss='categorical_crossentropy',metrics=[tf.keras.metrics.CategoricalAccuracy()])
